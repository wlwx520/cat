...
public class PersistentManager {
    ...
    public static void init() {
        if (Definiens.DB_CLEAR.equals("true")) {
            ...
            LOGGER.info("scan the package to find persistent in " + Definiens.PERSISTENT_BEAN_PACKAGE);

            Set<Class<?>> classes = ScanUtil.getClasses(Definiens.PERSISTENT_BEAN_PACKAGE);
